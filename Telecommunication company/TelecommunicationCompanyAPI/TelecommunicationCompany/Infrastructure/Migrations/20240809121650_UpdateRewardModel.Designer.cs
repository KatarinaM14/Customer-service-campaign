...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240809121650_UpdateRewardModel")]
    partial class UpdateRewardModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.BaseModels.Reward", b =>
                {
                    b.HasOne("Domain.Models.BaseModels.Customer", "Customer")
                        .WithMany("RewardsReceived")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
